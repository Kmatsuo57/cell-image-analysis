...
model_path = '/Users/matsuokoujirou/Documents/Data/Screening/Noemal_cells/best_autoencoder_optimized_v2.h5'
...
anomalous_labels = ['RG2_normal', 'ccm1', '1-1', "1-2", '1-3', '1-4', '2-1', "2-2", '2-3', '2-4']
...
# OC-SVMのハイパーパラメータ設定と学習
oc_svm = OneClassSVM(nu=0.01, gamma=0.1)  # ハイパーパラメータを調整
oc_svm.fit(normal_features_train_reduced)
...
plt.tight_layout()
plt.savefig(result_path + "/anomalous_cells_n001_g01_v2.png")
plt.show()
